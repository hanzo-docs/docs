---
title: Comparisons
description: How does Hanzo Docs different from other existing frameworks
---

<Callout type="info">This is for testing Hanzo Docs MDX Remote</Callout>

## Philosophy

Hanzo Docs, unlike the other frameworks, it expects you to write code and cooperate with other parts of your software.
...
**Hanzo Docs has no magic:** It gives you the utilities and a good-looking user interface.
...
**Opinionated on UI:** The only thing Hanzo Docs UI offers is **User Interface**, it is opinionated on UI for the best mobile responsibility and user experience.
...
advanced usages, Nextra is more opinionated than Hanzo Docs. Hanzo Docs is accelerated by App Router. As a result, It provides many server-side functions and you have to
...
Since Hanzo Docs is built on the top of Next.js, you'll have to start the Next.js dev
...
You can easily achieve many things with plugins. Although the flexibility of Hanzo Docs is high, their
...
fancy UI that's breathtaking, in these cases, Hanzo Docs can help you build the
