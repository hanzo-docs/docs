'use client';
import * as Base from '@/base/components/sidebar/base';
import { cn } from '@/cn';
import { type ComponentProps, useRef } from 'react';
import { cva } from 'class-variance-authority';
import { createPageTreeRenderer } from '@/base/components/sidebar/page-tree';
import { createLinkItemRenderer } from '@/base/components/sidebar/link-item';
import { buttonVariants } from '@/base/components/ui/button';
import { SearchToggle } from '@/base/layouts/shared/search-toggle';
