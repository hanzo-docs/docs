...
import { TreeContextProvider } from '@/base/contexts/tree';
import { cn } from '@/cn';
import { buttonVariants } from '@/base/components/ui/button';
import { Languages, Sidebar as SidebarIcon, X } from '@/icons';
import { LanguageToggle } from '@/base/layouts/shared/language-toggle';
import { ThemeToggle } from '@/base/layouts/shared/theme-toggle';
...
import {
  ...
  LayoutHeaderTabs,
  NavbarLinkItem,
} from '@/base/layouts/notebook/client';
import {
  LargeSearchToggle,
  SearchToggle,
} from '@/base/layouts/shared/search-toggle';
import { LinkItem, type LinkItemType } from '@/link-item';
import type { SidebarPageTreeComponents } from '@/base/components/sidebar/page-tree';
import {
  getSidebarTabs,
  type GetSidebarTabsOptions,
} from '@/base/components/sidebar/tabs';
import {
  SidebarTabsDropdown,
  type SidebarTabWithProps,
} from '@/base/components/sidebar/tabs/dropdown';
