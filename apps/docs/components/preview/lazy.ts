...
export const File = dynamic(() => import('hanzo-docs-ui/components/files').then((res) => res.File));
export const Files = dynamic(() => import('hanzo-docs-ui/components/files').then((res) => res.Files));
