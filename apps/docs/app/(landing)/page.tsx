    ...
    <main className="[grid-area:main] min-w-0 pb-6 md:pb-12">
      ...
      <div className="mx-auto w-full max-w-5xl px-6 md:px-8 space-y-24">
        ...
        <section>
          ...
          {/* 470 is the `xl:grid-cols-2` boundary stated as a width instead of a
              viewport: the page column is the viewport less the 268px rail, so
              xl (1280) is a ~964px column, which is exactly two 470px tracks and
              the gap. Said this way the pair also splits correctly when the rail
              is closed, which a viewport query cannot see. */}
