...
Full examples at:
- [examples/client](https://github.com/zap-protocol/zap-go/tree/main/examples/client)
- [examples/server](https://github.com/zap-protocol/zap-go/tree/main/examples/server)
- [examples/gateway](https://github.com/zap-protocol/zap-go/tree/main/examples/gateway)
