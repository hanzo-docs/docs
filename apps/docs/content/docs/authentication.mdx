...
[Auth](/docs/architecture/auth) is the full picture on the other side of that boundary: every header the edge mints, the difference between the effective org and the home org, how a project narrows within one, and how to read a 401 against a 403.
