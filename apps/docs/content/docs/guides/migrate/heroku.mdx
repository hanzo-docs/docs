...
| Flag add-ons, LaunchDarkly, Split | `/v1/flag` (8) — a definition and a deterministic decision |
| Heroku Managed Inference and Agents | `/v1/ai` (272) — the Zen models themselves, not a broker to somebody else's — plus `/v1/agent` (37) for the agent runtime |
...
| A function rather than a dyno | `/v1/function` (11) |
