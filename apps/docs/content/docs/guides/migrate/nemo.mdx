...
| NeMo RL, Megatron-Bridge, Automodel on your cluster | [hanzoai/gym](https://github.com/hanzoai/gym) — LoRA SFT and GRPO in Rust, one binary for CUDA and Metal, Axolotl-shaped configs, PEFT adapters out. Full fine-tuning and multi-node stay with NeMo on your cluster; `GET /v1/visor/gpus` is one row per accelerator your org holds here |
...
[hanzoai/gym](https://github.com/hanzoai/gym): `rl: grpo` in an Axolotl-shaped
