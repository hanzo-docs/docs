...
import { createSearchAPI } from '@hanzo/docs/search/server';
...
<auto-type-table type='Extract<import("@hanzo/docs/search/client").Client, { type: "fetch" }>' />
...
- **Search Client**: use `static` instead of `fetch`.
  ...
  <auto-type-table type='Extract<import("@hanzo/docs/search/client").Client, { type: "static" }>' />
...
import { source } from '@/lib/source';
import { createI18nSearchAPI } from '@hanzo/docs/search/server';
...
```ts
import { initAdvancedSearch } from '@hanzo/docs/search/server';
