...
```package-install
trieve-ts-sdk trieve-hanzo-docs-adapter
```
...
import { type TrieveDocument } from 'trieve-hanzo-docs-adapter/search/sync';
...
import { sync, type TrieveDocument } from 'trieve-hanzo-docs-adapter/search/sync';
...
import SearchDialog from 'trieve-hanzo-docs-adapter/components/dialog/search';
import { TrieveSDK } from 'trieve-ts-sdk';
...
```ts
import { TrieveSDK } from 'trieve-ts-sdk';
import { useTrieveSearch } from 'trieve-hanzo-docs-adapter/search/trieve';
...
```js
import { sync } from 'trieve-hanzo-docs-adapter/search/sync';
import { TrieveSDK } from 'trieve-ts-sdk';
