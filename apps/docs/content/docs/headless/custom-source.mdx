...
- [BaseHub](https://github.com/fuma-nama/hanzo-docs-basehub)
- [Sanity](https://github.com/fuma-nama/hanzo-docs-sanity)
- [Community: Payload CMS by `MFarabi619`](https://github.com/MFarabi619/hanzo-docs-payloadcms)
- [Community: Payload CMS by `bapspatil`](https://github.com/bapspatil/hanzo-docs-payload-template)
...
Hanzo Docs offers the **MDX Remote** package, it is a helper to integrate Markdown-based content sources with Hanzo Docs.
