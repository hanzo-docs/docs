...
The individual SDK repos (`python-sdk`, `js-sdk`, `go-sdk`, `rust-sdk`) are **generated API clients** focused on typed HTTP wrappers for `api.hanzo.ai`. This unified SDK is different:
