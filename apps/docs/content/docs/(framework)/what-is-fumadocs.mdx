...
Hanzo Docs was created because the creator Fuma wanted a more customisable experience for building docs, to be a docs framework that is not opinionated, **a "framework" that you can break**.
...
Instead, we follow a much more flexible approach inspired by Shadcn UI — [Hanzo Docs CLI](/docs/cli), allowing you to "fork" a part of Hanzo Docs UI, and fully customise it.
