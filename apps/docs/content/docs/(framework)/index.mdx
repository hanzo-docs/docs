...
Hanzo Docs <span className='text-fd-muted-foreground text-sm'>(Hanzo docs)</span> is a **documentation framework**, designed to be fast, flexible,
...
```bash tab="npm"
npm create @hanzo/docs-create-app
```

```bash tab="pnpm"
pnpm create @hanzo/docs-create-app
```
