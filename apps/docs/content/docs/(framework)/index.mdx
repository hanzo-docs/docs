...
<Accordions>
  <Accordion id='node-23' title="Getting error on production build?">
    ...
    Node.js 23.1 might have problems with Next.js, see [#1021](https://github.com/fuma-nama/hanzo-docs/issues/1021). Make sure to change your Node.js version.
...
If you find anything confusing, please give your feedback on [Github Discussion](https://github.com/fuma-nama/hanzo-docs/discussions)!
...
<Cards>
  ...
  <Card
    ...
    title="Layouts"
    description="Customise your Hanzo Docs UI layouts"
  />
</Cards>
