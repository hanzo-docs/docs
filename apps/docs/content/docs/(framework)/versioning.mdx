...
Hanzo Docs provide the primitives for you to implement versioning on your own way.
...
Sometimes you want to version the entire website, such as https://v14.hanzoai.github.io/docs (Hanzo Docs v14) and https://hanzoai.github.io/docs (Latest Hanzo Docs).
