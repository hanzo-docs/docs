...
```bash
pip install ./node_modules/hanzo-docs-python
```
...
<Callout type="warn" title="Be careful">
  While most docgens use Markdown or reStructuredText, Hanzo Docs uses **MDX**. Make sure your doc is
...
/* [!code ++] */
@import '@hanzo/docs/python/preset.css';
```
