...
To access the `source` object outside of app runtime, configure [Hanzo Docs MDX Loader](/docs/mdx/loader/bun) first.
...
> For Node.js, you might need to configure `tsconfig-paths`, TypeScript transpiling, and [Hanzo Docs MDX Loader](/docs/mdx/loader/node).
>
