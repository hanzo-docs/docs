---
title: Performance
description: The performance of Hanzo Docs MDX
icon: Rocket
---

## Overview

Hanzo Docs MDX is a bundler plugin, in other words, it has a higher performance bottleneck.
...
Since Hanzo Docs MDX works with your bundler, you can import any files including client components in your MDX files.
This allows high flexibility and ensures everything is optimized by default.

### Image Optimization

Hanzo Docs MDX resolves images into static imports with [Remark Image](/docs/headless/mdx/remark-image).
...
Although Hanzo Docs MDX can handle nearly 500+ files, it could be slow and inefficient.
