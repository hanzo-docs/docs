...
- Hanzo IAM with an MCP application ([Setup](./setup))
...
- **[Setup Guide →](./setup)**: Review Hanzo IAM and MCP server configuration
...
- **[Custom Scopes →](../application/scopes)**: Learn more about defining granular permissions
