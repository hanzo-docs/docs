...
**Reference**: See [Application Categories](../application/categories) for more details on Agent vs Default applications.
...
See [Third-party Integration](./third-party-integration) for complete code examples in Python, Node.js, and Go.
