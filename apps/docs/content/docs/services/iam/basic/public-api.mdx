...
1. **Query parameter:**
    ...
    Demo site example: `https://iam.hanzo.ai/v1/iam/get-global-providers?access_token=eyJhbGciOiJSUzI1NiIs`
...
Example: `https://iam.hanzo.ai/v1/iam/get-global-providers?accessKey=...&accessSecret=...`

![User Api Key](/img/basic/user_api_key.png)

```bash
curl --location 'http://iam.hanzo.ai/v1/iam/user?accessKey=b86db9dc-6bd7-4997-935c-af480dd2c796&accessSecret=79911517-fc36-4093-b115-65a9741f6b14'
