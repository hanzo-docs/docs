---
title: Observability
description: Health checks, metrics, alerts, logs, and service maps via Datastore, Loki, and Grafana.
---
...
|-----------|---------|---------|
| Traces | OTEL Collector → Datastore | Distributed tracing |
...
| Dashboards | Grafana + Datastore plugin | Visual monitoring |
