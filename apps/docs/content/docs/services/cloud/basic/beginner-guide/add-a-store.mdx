...
This guide assumes that you have already deployed a Hanzo Cloud knowledge base system. If you haven't done, please refer to the [Deploy Hanzo IAM and Hanzo Cloud](../../deployment/deploy-iam-and-cloud) tutorial.
