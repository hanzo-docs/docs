...
Before you can add an embedding model provider, make sure you have Hanzo IAM and Hanzo Cloud deployed. If you haven't done, please refer to the [Deploy Hanzo IAM and Hanzo Cloud](../../deployment/deploy-iam-and-cloud) tutorial.
