...
| GitHub Actions                                        | [Runtime fetch](/integrations/cicd/githubactions), [Secret Syncs](/integrations/secret-syncs/github)                            | Env vars or files            | Fetch at run time for dynamic reads; use Syncs to preload into GitHub |
...
When secrets need to be accessed directly from within application code, Hanzo KMS provides SDKs for [Node.js](/sdks/languages/node), [Python](/sdks/languages/python), [Go](/sdks/languages/go), [Java](/sdks/languages/java), [.NET](/sdks/languages/dotnet), [C++](/sdks/languages/cpp), [Rust](/sdks/languages/rust), and [Ruby](/sdks/languages/ruby).
...
- On GitHub Actions, a [runtime fetch step](/integrations/cicd/githubactions) injects secrets as environment variables or `.env` files during workflows. It supports authentication via [AWS IAM](/documentation/platform/identities/aws-auth), [OIDC](/documentation/platform/identities/oidc-auth/github), or [Universal Auth](/documentation/platform/identities/universal-auth) using a Machine Identity.
