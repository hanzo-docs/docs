  ...
  <Tab title="Kubernetes">
    ...
    <Tabs>
      <Tab title="Thales Luna Cloud HSM">
        ...
        <Note>
          This is only supported on helm chart version `1.7.1` and above. Hanzo does not publish a standalone-postgres Helm chart changelog; the Kubernetes manifests live under [`k8s/`](https://github.com/luxfi/kms/tree/main/k8s) in the KMS repository.
        </Note>
      ...
      <Tab title="AWS CloudHSM">
        ...
        <Note>
          AWS CloudHSM is supported on helm chart version `1.7.1` and above. Hanzo does not publish a standalone-postgres Helm chart changelog; the Kubernetes manifests live under [`k8s/`](https://github.com/luxfi/kms/tree/main/k8s) in the KMS repository.
        </Note>
