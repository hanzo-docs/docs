...
We're looking to add support for other Windows versions in the future. If you're using a different Windows version, let us know through your Hanzo support channel and we'll look into adding support for your desired version.
