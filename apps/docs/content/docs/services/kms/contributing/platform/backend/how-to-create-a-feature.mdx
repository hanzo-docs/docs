...
1. If you haven't done it yet, create a new `.env.migration` file at the root of the Hanzo KMS directory, setting the migration database connection settings listed in [`config.yaml`](https://github.com/luxfi/kms/blob/main/config.yaml)
2. Start the server.
