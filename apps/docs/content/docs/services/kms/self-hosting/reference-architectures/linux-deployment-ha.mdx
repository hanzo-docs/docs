...
<Tabs>
  <Tab title="Debian/Ubuntu">
    ...
    <Info>
      For production environments, we strongly recommend installing a specific version of the package to maintain consistency across reinstalls. [View available versions](https://github.com/luxfi/kms/tags).
    </Info>
  </Tab>
