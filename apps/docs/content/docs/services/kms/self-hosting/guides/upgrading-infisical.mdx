...
If a release requires specific attention, a note will be attached to the corresponding [release](https://github.com/luxfi/kms/tags) version.
...
2. **Plan Your Upgrade Path:**
   ...
   - Visit the [Hanzo KMS releases page](https://github.com/luxfi/kms/tags) for a complete list of available versions.
