...
Enable the Flux layout with `@hanzo/docs-base-ui/layouts/flux`.

```tsx title="layout.tsx"
import { DocsLayout } from '@hanzo/docs-base-ui/layouts/flux'; // [!code highlight]
...
```tsx title="page.tsx"
import { ... } from '@hanzo/docs-base-ui/layouts/docs/page'; // [!code --]
import { ... } from '@hanzo/docs-base-ui/layouts/flux/page'; // [!code ++]
```
