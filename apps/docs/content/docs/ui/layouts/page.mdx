...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from '@hanzo/docs-base-ui/layouts/docs/page';
...
import { DocsPage, DocsDescription, DocsTitle, DocsBody } from '@hanzo/docs-base-ui/layouts/notebook/page';
...
<DocsPage>
  <a
    href={`https://github.com/fuma-nama/hanzo-docs/blob/main/content/docs/${page.path}`}
...
```tsx
// docs layout:
import { DocsPage, PageLastUpdate } from '@hanzo/docs/ui/layouts/docs/page';
// notebook layout:
import { DocsPage, PageLastUpdate } from '@hanzo/docs/ui/layouts/notebook/page';
