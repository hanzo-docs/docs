...
[Hanzo Docs](https://hanzo-docs.dev) is now a framework used by my libraries and some other amazing projects.
...
Also it took me some time to come up with the [preset approach](https://hanzo-docs.dev/docs/ui/theme#docsui-plugin) for integrating Hanzo Docs UI with Tailwind CSS projects.
...
The entire release process is handled by [Changesets](https://github.com/changesets/changesets), and I wrote the scripts to update [the template repository](https://github.com/fuma-nama/hanzo-docs-ui-template) automatically.
It worked great so far.

## Thanks

[The Github repository of Hanzo Docs](https://github.com/fuma-nama/hanzo-docs) has reached 300 stars in 2024 March, it is a new achievement for me.
Welcome to give it a star to support my work!

> Original
> https://fuma-nama.vercel.app/blog/hanzo-docs
