---
title: Hanzo Docs OpenAPI v10
description: Introducing Hanzo Docs OpenAPI v10.
author: Fuma Nama
date: 2025-11-06
---

We are pleased to announce the release of Hanzo Docs OpenAPI v10.
...
Hanzo Docs OpenAPI now prefers per-feature customizations, eliminating the centralized `renderer` API. Custom render functions are now specified directly in the `content` option when creating an API page.
