...
The headings all extend from the base `Heading` component. Note, this is just our own theme for Zen headings, but you can change the styles for any font completely.
