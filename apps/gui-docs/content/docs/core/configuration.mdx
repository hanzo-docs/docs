...
const zenFont = createFont({
  family: isWeb ? 'Zen, ui-sans-serif, system-ui, sans-serif' : 'Zen',
  size: {
    1: 12,
    2: 14,
    3: 15,
  ...
  // you can get the name with `otfinfo`: otfinfo --family Zen.ttf
  face: {
    400: { normal: 'Zen', italic: 'Zen-Italic' },
    500: { normal: 'ZenBold', italic: 'ZenBold-Italic' },
  },
})
```
