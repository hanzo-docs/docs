      ...
      <main>
        ...
        <section className="relative pt-24 pb-20 px-4 md:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center">
              ...
              >
                Enterprise-grade security built into every layer. Your data is
                encrypted, access is controlled, and compliance is maintained by default.
              </motion.p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              >
                ...
                <p className="text-neutral-400 mb-8">
                  Our infrastructure runs on enterprise-grade data centers with 24/7
                  physical security, redundant power, and isolated network architecture.
              ...
              >
                ...
                <p className="text-neutral-400 mb-6">
                  Deploy globally with automatic scaling and data residency controls to
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="bg-gradient-to-br from-[#fd4444]/10 to-transparent rounded-xl p-8 border border-[#fd4444]/20">
                  ...
                  <p className="text-neutral-400 mb-6">
                    For organizations with advanced security requirements, our Enterprise
                    plan includes dedicated security support and custom configurations.
                  </p>
              ...
              >
                ...
                <p className="text-neutral-400">
                  Our security team works directly with enterprise customers to
                  understand their unique requirements and implement appropriate controls.
                </p>
              </motion.div>
            </div>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-400 mb-4">
                    ...
                    security researchers. If you discover a vulnerability, please report
                    it responsibly.
                  </p>
                  <a
        ...
        <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-neutral-900/30 to-black relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              Start building with enterprise-grade security today. Our team is ready to
