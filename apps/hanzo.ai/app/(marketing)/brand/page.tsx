...
import { Palette, Download, Type, Grid3X3, Sparkles, ArrowRight } from 'lucide-react';
...
const ColorSwatch = ({ name, hex, className }: ColorSwatchProps) => (
  <div className="space-y-2">
    <div
      className={`w-full aspect-square rounded-lg ${className} border border-neutral-800`}
    ></div>
      ...
      <main>
        ...
        <section className="relative pt-24 pb-16 px-4 md:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center">
              ...
              >
                A comprehensive guide for creating consistent, elegant, and minimal
                interfaces across our platform and products.
              </motion.p>
            ...
            <div className="space-y-8">
              ...
              >
                <ComponentShowcase title="Buttons">
                  ...
                  <button className="px-6 py-3 rounded-full font-medium border border-neutral-700 text-white hover:bg-neutral-900">
                    Secondary Button
                  </button>
                  <button className="px-6 py-3 font-medium text-white hover:bg-neutral-900 rounded-lg">
                    Ghost Button
                  </button>
                  <button className="font-medium text-[#fd4444]">Link Button</button>
                </ComponentShowcase>
              </motion.div>
                ...
                <ComponentShowcase title="Cards">
                  <div className="w-full max-w-md p-6 rounded-xl bg-neutral-900/50 border border-neutral-800 hover:border-[#fd4444]/30 transition-colors">
                    ...
                    <p className="text-neutral-400 mb-4">
                      This is a standard card component with hover states and consistent
                      styling.
                    </p>
                    <button className="text-sm px-4 py-2 rounded-full border border-neutral-700 text-white hover:bg-neutral-900">
                      Learn More
                    </button>
                  </div>
                </ComponentShowcase>
        ...
        <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-neutral-900/30 to-black relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              Our team can help with custom assets, co-branding requests, and other
