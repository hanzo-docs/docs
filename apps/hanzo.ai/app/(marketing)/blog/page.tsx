...
const blogPosts = [
  {
    ...
    excerpt:
      "Today we're excited to announce the release of Hanzo AI v3, our most powerful and flexible AI development platform yet.",
    date: 'May 15, 2024',
    author: 'Zach Kelling',
    category: 'Product',
  ...
  },
  {
    ...
    excerpt:
      "In this tutorial, we'll show you how to create a custom AI chatbot using Hanzo Bot that can integrate with your existing systems.",
    date: 'June 3, 2024',
    author: 'David Tai',
    category: 'Tutorial',
  ...
  },
  {
    ...
    excerpt:
      'Explore how AI is transforming the e-commerce landscape and how Hanzo Commerce is leading the revolution.',
    date: 'July 12, 2024',
  ...
  },
  {
    ...
    excerpt:
      "Learn how to scale your AI applications efficiently using Hanzo Vector's advanced embedding and semantic search capabilities.",
    date: 'August 24, 2024',
      ...
      <main>
        ...
        <section className="relative pt-24 pb-16 px-4 md:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center">
              ...
              >
                Tutorials, product updates, and deep dives into AI development from the
        ...
        <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-neutral-900/30 to-black relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              Get the latest Hanzo news, product updates, and tutorials delivered
