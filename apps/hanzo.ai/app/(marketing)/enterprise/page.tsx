...
const features = [
  {
    ...
    description:
      'Enterprise-grade security with GDPR controls, encryption, and comprehensive audit logging.',
  },
  {
    icon: Users,
    title: 'User Management',
    description:
      'SCIM provisioning, SSO integration, and granular role-based access control.',
  },
  {
    icon: Globe,
    title: 'Global Infrastructure',
    description:
      'Multi-region deployment with 99.99% uptime SLA and dedicated support channels.',
  },
  {
    icon: Zap,
    title: 'Custom AI Resources',
    description:
      'Tailored AI credits, custom models, and dedicated compute infrastructure.',
  },
];
...
const benefits = [
  {
    ...
    description:
      'Priority support with dedicated account managers, guaranteed response times, and direct access to our engineering team.',
  ...
  },
  {
    ...
    description:
      'Seamlessly integrate with your existing infrastructure, identity providers, and business systems.',
  ...
  },
  {
    ...
    description:
      'Deploy on our cloud, your cloud, or on-premises. We support hybrid deployments for security and compliance.',
      ...
      <main>
        ...
        <section className="relative pt-24 pb-16 px-4 md:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center">
              ...
              >
                Scale your business with enterprise-grade AI solutions. Get dedicated
                support, custom integrations, and advanced security features designed for
                large organizations.
              </motion.p>
        ...
        <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-neutral-900/30 to-black relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              Contact our enterprise sales team for a personalized demo and custom
              pricing that meets your organization's unique needs.
            </motion.p>
