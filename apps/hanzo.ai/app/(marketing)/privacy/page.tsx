...
import { Shield, Lock, Eye, FileText, ArrowRight, CheckCircle } from 'lucide-react';
...
const PRIVACY_HIGHLIGHTS = [
  {
    ...
    description:
      'Your data is encrypted at rest and in transit with industry-standard encryption.',
  },
  {
    icon: Lock,
  ...
  },
  {
    ...
    title: 'Your Rights',
    description:
      'You have full control over your data with the right to access, modify, or delete it.',
  },
];
      ...
      <main>
        ...
        <section className="relative pt-24 pb-16 px-4 md:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center">
              ...
              >
                We believe in transparency and giving you control over your data. This
            ...
            <div className="prose prose-invert max-w-none">
              ...
              >
                ...
                <p className="text-neutral-300 mb-6">
                  ...
                  services, including personal information such as your name, email
                  address, and payment information. We also collect usage data and
                ...
                <p className="text-neutral-300 mb-6">
                  ...
                  services, process transactions, send communications, and develop new
                ...
                <p className="text-neutral-300 mb-6">
                  ...
                  help us operate our business and provide our services. We may also
                  share information if required by law or to protect our rights.
                </p>
                ...
                <p className="text-neutral-300 mb-6">
                  ...
                  information. All data is encrypted at rest with AES-256 and in transit
                  with TLS 1.3.
                </p>
                ...
                <p className="text-neutral-300 mb-6">
                  ...
                  by logging into your account or contacting us directly. Under GDPR and
                  CCPA, you have additional rights including data portability and the
                  right to opt-out.
                </p>
        ...
        <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-neutral-900/30 to-black relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              Our team is here to help. Contact us for any questions about how we handle
              your data.
            </motion.p>
