...
import { FileText, Scale, Shield, Clock, ArrowRight } from 'lucide-react';
        ...
        <section className="relative pt-24 pb-16 px-4 md:px-8 lg:px-12 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="text-center">
              ...
              >
                These terms govern your use of Hanzo AI platform and services. We've
                written them in plain language to be as clear as possible.
              </motion.p>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              >
                ...
                <p className="text-neutral-300 mb-6">
                  Our services are provided for business and development purposes. You
                  may use our services only as permitted by these terms and any
                ...
                <p className="text-neutral-300 mb-6">
                  ...
                  Hanzo AI cannot and will not be liable for any loss or damage from your
                ...
                <p className="text-neutral-300 mb-6">
                  Content you create using our services remains yours. However, by using
                  our services, you grant us a license to use, host, store, reproduce,
                  and modify such content as needed to provide the services.
                </p>
                ...
                <p className="text-neutral-300 mb-6">
                  Our APIs are subject to rate limits and usage restrictions. Excessive
                  use that negatively impacts our services or other users may result in
                  temporary or permanent restriction of your access.
                </p>
                ...
                <p className="text-neutral-300 mb-6">
                  In no event shall Hanzo AI be liable for any indirect, incidental,
                ...
                <p className="text-neutral-300 mb-6">
                  ...
                  notice of significant changes by posting an announcement on our website
