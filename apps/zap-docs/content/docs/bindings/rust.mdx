...
# Optional features
zap-protocol = { version = "0.1", features = ["pq-tls", "corona", "did"] }
```
...
```toml
[dependencies]
zap-protocol = { version = "0.1", features = ["corona"] }
```
...
- [zap-protocol/examples/client.rs](https://github.com/zap-protocol/zap-rs/blob/main/examples/client.rs)
- [zap-protocol/examples/server.rs](https://github.com/zap-protocol/zap-rs/blob/main/examples/server.rs)
- [zap-protocol/examples/gateway.rs](https://github.com/zap-protocol/zap-rs/blob/main/examples/gateway.rs)
