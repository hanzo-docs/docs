...
Full examples at:
- [examples/client.py](https://github.com/zap-protocol/zap-py/blob/main/examples/client.py)
- [examples/server.py](https://github.com/zap-protocol/zap-py/blob/main/examples/server.py)
- [examples/gateway.py](https://github.com/zap-protocol/zap-py/blob/main/examples/gateway.py)
