...
<Cards>
  <Card title="Rust" description="Reference implementation with full async support" href="/docs/bindings/rust" />
  <Card title="Go" description="Idiomatic Go with goroutine-safe clients" href="/docs/bindings/go" />
  <Card title="Python" description="Async/await API with pycapnp" href="/docs/bindings/python" />
  <Card title="JavaScript" description="Node.js and browser support" href="/docs/bindings/javascript" />
  <Card title="C++" description="High-performance native binding" href="/docs/bindings/cpp" />
  <Card title="C" description="Minimal C API for embedded" href="/docs/bindings/c" />
  <Card title="Java" description="JVM binding with Netty transport" href="/docs/bindings/java" />
  <Card title="C#" description=".NET binding with async support" href="/docs/bindings/csharp" />
  <Card title="Erlang" description="OTP-compatible binding" href="/docs/bindings/erlang" />
  <Card title="OCaml" description="Functional binding with Lwt" href="/docs/bindings/ocaml" />
  <Card title="Haskell" description="Pure functional binding" href="/docs/bindings/haskell" />
</Cards>
