...
Full examples at:
- [examples/client.ts](https://github.com/zap-protocol/zap-js/blob/main/examples/client.ts)
- [examples/server.ts](https://github.com/zap-protocol/zap-js/blob/main/examples/server.ts)
- [examples/browser.ts](https://github.com/zap-protocol/zap-js/blob/main/examples/browser.ts)
