...
import { frontmatter as __fd_glob_24 } from "../content/docs/integrations/agent-platform.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_23 } from "../content/docs/getting-started/install.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_22 } from "../content/docs/getting-started/index.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_21 } from "../content/docs/getting-started/homebrew.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_20 } from "../content/docs/getting-started/authentication.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_19 } from "../content/docs/reference/index.mdx?collection=docs&only=frontmatter"
import { frontmatter as __fd_glob_18 } from "../content/docs/reference/cli.mdx?collection=docs&only=frontmatter"
...
export const docs = await create.docsLazy("docs", "content/docs", {"meta.json": __fd_glob_0, "contributing/meta.json": __fd_glob_1, "architecture/meta.json": __fd_glob_2, "configuration/meta.json": __fd_glob_3, "getting-started/meta.json": __fd_glob_4, "integrations/meta.json": __fd_glob_5, "reference/meta.json": __fd_glob_6, "usage/meta.json": __fd_glob_7, }, {"faq.mdx": __fd_glob_8, "index.mdx": __fd_glob_9, "architecture/agent-mesh.mdx": __fd_glob_10, "architecture/index.mdx": __fd_glob_11, "configuration/example-config.mdx": __fd_glob_12, "configuration/index.mdx": __fd_glob_13, "configuration/platform-sandboxing.mdx": __fd_glob_14, "configuration/sandbox.mdx": __fd_glob_15, "contributing/cla.mdx": __fd_glob_16, "contributing/index.mdx": __fd_glob_17, "reference/cli.mdx": __fd_glob_18, "reference/index.mdx": __fd_glob_19, "getting-started/authentication.mdx": __fd_glob_20, "getting-started/homebrew.mdx": __fd_glob_21, "getting-started/index.mdx": __fd_glob_22, "getting-started/install.mdx": __fd_glob_23, "integrations/agent-platform.mdx": __fd_glob_24, "integrations/copilot.mdx": __fd_glob_25, "integrations/index.mdx": __fd_glob_26, "integrations/zed.mdx": __fd_glob_27, "usage/advanced.mdx": __fd_glob_28, "usage/agents.mdx": __fd_glob_29, "usage/auto-drive.mdx": __fd_glob_30, "usage/exec.mdx": __fd_glob_31, "usage/execpolicy.mdx": __fd_glob_32, "usage/index.mdx": __fd_glob_33, "usage/js-repl.mdx": __fd_glob_34, "usage/prompts.mdx": __fd_glob_35, "usage/settings.mdx": __fd_glob_36, "usage/skills.mdx": __fd_glob_37, "usage/slash-commands.mdx": __fd_glob_38, }, {"faq.mdx": () => import("../content/docs/faq.mdx?collection=docs"), "index.mdx": () => import("../content/docs/index.mdx?collection=docs"), "architecture/agent-mesh.mdx": () => import("../content/docs/architecture/agent-mesh.mdx?collection=docs"), "architecture/index.mdx": () => import("../content/docs/architecture/index.mdx?collection=docs"), "configuration/example-config.mdx": () => import("../content/docs/configuration/example-config.mdx?collection=docs"), "configuration/index.mdx": () => import("../content/docs/configuration/index.mdx?collection=docs"), "configuration/platform-sandboxing.mdx": () => import("../content/docs/configuration/platform-sandboxing.mdx?collection=docs"), "configuration/sandbox.mdx": () => import("../content/docs/configuration/sandbox.mdx?collection=docs"), "contributing/cla.mdx": () => import("../content/docs/contributing/cla.mdx?collection=docs"), "contributing/index.mdx": () => import("../content/docs/contributing/index.mdx?collection=docs"), "reference/cli.mdx": () => import("../content/docs/reference/cli.mdx?collection=docs"), "reference/index.mdx": () => import("../content/docs/reference/index.mdx?collection=docs"), "getting-started/authentication.mdx": () => import("../content/docs/getting-started/authentication.mdx?collection=docs"), "getting-started/homebrew.mdx": () => import("../content/docs/getting-started/homebrew.mdx?collection=docs"), "getting-started/index.mdx": () => import("../content/docs/getting-started/index.mdx?collection=docs"), "getting-started/install.mdx": () => import("../content/docs/getting-started/install.mdx?collection=docs"), "integrations/agent-platform.mdx": () => import("../content/docs/integrations/agent-platform.mdx?collection=docs"), "integrations/copilot.mdx": () => import("../content/docs/integrations/copilot.mdx?collection=docs"), "integrations/index.mdx": () => import("../content/docs/integrations/index.mdx?collection=docs"), "integrations/zed.mdx": () => import("../content/docs/integrations/zed.mdx?collection=docs"), "usage/advanced.mdx": () => import("../content/docs/usage/advanced.mdx?collection=docs"), "usage/agents.mdx": () => import("../content/docs/usage/agents.mdx?collection=docs"), "usage/auto-drive.mdx": () => import("../content/docs/usage/auto-drive.mdx?collection=docs"), "usage/exec.mdx": () => import("../content/docs/usage/exec.mdx?collection=docs"), "usage/execpolicy.mdx": () => import("../content/docs/usage/execpolicy.mdx?collection=docs"), "usage/index.mdx": () => import("../content/docs/usage/index.mdx?collection=docs"), "usage/js-repl.mdx": () => import("../content/docs/usage/js-repl.mdx?collection=docs"), "usage/prompts.mdx": () => import("../content/docs/usage/prompts.mdx?collection=docs"), "usage/settings.mdx": () => import("../content/docs/usage/settings.mdx?collection=docs"), "usage/skills.mdx": () => import("../content/docs/usage/skills.mdx?collection=docs"), "usage/slash-commands.mdx": () => import("../content/docs/usage/slash-commands.mdx?collection=docs"), });