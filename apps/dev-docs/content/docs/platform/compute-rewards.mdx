---
title: AI Compute Rewards
description: "HIP-XXX: Economic design for AI coin rewards distributed to compute resource contributors."
---
...
- Less than 1% reward calculation variance
...
- Less than 0.1% fraudulent claims
